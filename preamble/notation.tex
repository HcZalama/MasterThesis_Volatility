...
%    * rho is a correlation, always. Densities are p (transition) or f.
...
% ---------- Stochastic calculus ----------
\newcommand{\dd}{\mathrm{d}}                 % upright differential (optional; see note)
...
\newcommand{\Bond}[2]{P(#1,#2)}              % zero-coupon bond price
\newcommand{\Payoff}{H}                      % terminal payoff (random variable)
...
\newcommand{\Carry}{\Theta}                  % spot-to-forward conversion factor (Ch. 1)
