...
%  Lead-lag coefficient of the two-asset model (Def. "Lead--lag pair", Ch. 3, and
%  Section "The Levy Area of an Index Pair", Ch. 4). It is NOT theta: theta is the
%  Heston long-run variance and is in use a few pages earlier, in the rough Heston
%  calibration of the same chapter. \varkappa is free throughout the dissertation,
%  and kappa (Heston mean reversion) never appears in either section that uses this.
\newcommand{\leadlag}{\varkappa}                % lead--lag coefficient
