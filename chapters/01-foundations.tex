...
However, the de-Americanisation process can be inverted, and this must be of no suprise at this stage, by the so called PINNs (\textit{Physics-Informed Neural Networks}). We will dive further into this topic in the final chapter of the present dissertation.
