...
Brownian motion, and built the It\^o integral. We also obtained some results on the roughness of
...
fit nearly as well, and it pushed the Hurst parameter to the smooth end of its range. That looks
like evidence that this market is not rough, but it is not. As \S\ref{subsec:rhidentification} shows, the
...
thing to know than a fitted number would have been. The third study was the L\'evy area for a pair of assets, where the computations of rough path theory were carried out on real data.
