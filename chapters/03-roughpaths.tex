...
if and only if $\Hurst = \tfrac12$. \hfill $\square$
\end{theorem}
...
\eqref{eq:controlleddef}. \hfill $\square$
\end{theorem}
...
is the Riemann--Stieltjes integral. \hfill $\square$
\end{proposition}
...
\end{equation}
uniformly in $s\leq t$. \hfill $\square$
\end{proposition}
...
\end{equation}
and the bounds $|X^n_{s,t}| \leq C_n\,|t-s|^{n\alpha}$ for every $n$. \hfill $\square$
\end{theorem}
...
signature if and only if they coincide up to tree-like pieces. \hfill $\square$
\end{theorem}
...
\ref{thm:signatureuniqueness}. \hfill $\square$
\end{theorem}
