...
sense in which It\^o's theory becomes unavailable, and Lyons' resolution through the extension of a path by its
iterated integrals. Chapter \ref{ch:applications} brings the theory to data, where the models are calibrated,
